                        ...
                        <div class="row gx-3 mb-3">
                            <div class="col-md-6">
                                ...
                                <input class="form-control" id="inputFirstName" type="text"
                                    placeholder="Enter your first name" value="escribe...">
                            </div>
                            <div class="col-md-6">
                                <label class="small mb-1" for="inputLastName">DEPARTAMENTO ACADEMICO</label>
                                <input class="form-control" id="inputLastName" type="text"
                                    placeholder="Enter your last name" value="escribe...">
                            </div>
                            <div class="row gx-3 mb-3">
                                <div class="col-md-6">
                            ...
                            <div class="row gx-3 mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control" id="inputOrgName" type="text"
                                        placeholder="Enter your organization name" value="escribe...">
                                </div>
                                <div class="col-md-6">
                                    <label class="small mb-1" for="inputLocation">TELEFONO</label>
                                    <input class="form-control" id="inputLocation" type="text"
                                        placeholder="Enter your location" value="escribe...">
                                </div>
                            </div>
                            <div class="mb-3">
                                <label class="small mb-1" for="inputEmailAddress">EMAIL</label>
                                <input class="form-control" id="inputEmailAddress" type="email"
                                    placeholder="Enter your email address" value="escribe...">
                            </div>
                            <div class="row gx-3 mb-3">
                                <div class="col-md-6">
                                    <label class="small mb-1" for="inputPhone">SEXO</label>
                                    <input class="form-control" id="inputPhone" type="tel"
                                        placeholder="Enter your phone number" value="escribe...">
                                </div>
                                <div class="col-md-6">
                                    <label class="small mb-1" for="inputBirthday">FECHA DE NACIMIENTO</label>
                                    <input class="form-control" id="inputBirthday" type="text" name="birthday"
                                        placeholder="Enter your birthday" value="escribe...">
                                </div>
                            </div>
